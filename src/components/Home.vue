      ...
      <div>
        ...
        <div id="container">
          ...
          <div id="content">
            ...
            <hr>
            <div id="email" v-if="isDesktop">E-mail: cobaltbluestars@gmail.com</div> 
            <div id="email" v-else>E-mail: <br>cobaltbluestars<br>@gmail.com</div> 
          </div>
  ...
  export default {
    name: 'MyPage',
    mounted() {
      // 화면 크기에 따라 Firebase 또는 Fire<br>base로 표시
